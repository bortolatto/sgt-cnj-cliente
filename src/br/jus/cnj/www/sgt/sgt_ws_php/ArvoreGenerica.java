...
public class ArvoreGenerica  implements java.io.Serializable {
    ...
    private br.jus.cnj.www.sgt.sgt_ws_php.ArvoreGenerica[] filhos;
    ...
    public ArvoreGenerica(
           ...
           br.jus.cnj.www.sgt.sgt_ws_php.ArvoreGenerica[] filhos) {
     ...
     * @return filhos
     */
    public br.jus.cnj.www.sgt.sgt_ws_php.ArvoreGenerica[] getFilhos() {
        return filhos;
    }
     ...
     * @param filhos
     */
    public void setFilhos(br.jus.cnj.www.sgt.sgt_ws_php.ArvoreGenerica[] filhos) {
        this.filhos = filhos;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.cnj.jus.br/sgt/sgt_ws.php", "ArvoreGenerica"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.cnj.jus.br/sgt/sgt_ws.php", "ArvoreGenerica"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
	...
	public String toString() {
		return "ArvoreGenerica [seq_elemento=" + seq_elemento + ", dsc_elemento=" + dsc_elemento + ", seq_elemento_pai="
				+ seq_elemento_pai + ", temFilhos=" + temFilhos + ", situacao=" + situacao + ", filhos="
				+ Arrays.toString(filhos) + "]";
	}
