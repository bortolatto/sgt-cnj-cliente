...
public class Item  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://www.cnj.jus.br/sgt/sgt_ws.php", "Item"));
	...
	public String toString() {
		return "Item [cod_item=" + cod_item + ", cod_item_pai=" + cod_item_pai + ", nome=" + nome + ", dscGlossario="
				+ dscGlossario + ", __equalsCalc=" + __equalsCalc + ", __hashCodeCalc=" + __hashCodeCalc + "]";
	}
