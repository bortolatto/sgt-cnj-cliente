...
public class Sgt_ws_methodsPortProxy implements br.jus.cnj.www.sgt.sgt_ws_php.Sgt_ws_methodsPort {
  private String _endpoint = null;
  private br.jus.cnj.www.sgt.sgt_ws_php.Sgt_ws_methodsPort sgt_ws_methodsPort = null;
  ...
  private void _initSgt_ws_methodsPortProxy() {
    try {
      sgt_ws_methodsPort = (new br.jus.cnj.www.sgt.sgt_ws_php.Sgt_ws_methodsServiceLocator()).getsgt_ws_methodsPort();
  ...
  public br.jus.cnj.www.sgt.sgt_ws_php.Sgt_ws_methodsPort getSgt_ws_methodsPort() {
    if (sgt_ws_methodsPort == null)
      _initSgt_ws_methodsPortProxy();
